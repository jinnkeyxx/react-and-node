    ...
    return (
        ...
        >
            <div className="menu">
                ...
                <DropdownItemImage image="/assets/img/user.jpg">{JSON.stringify(user)}</DropdownItemImage>
...
export default connect(mapStateToProps)(withRouter(DesktopContainer));